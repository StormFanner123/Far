...
Profile.create(name: "Michael Holly", level: 21, city: "Sydney", country: "AU", age: 19, bio: "This is my great bio", user_id: 3)
User.create(email: "sam@example.com", password: "12345678", id: 4)
Profile.create(name: "Sam Ham", level: 22, city: "Sydney", country: "AU", age: 17, bio: "This is my great bio", user_id: 4)
User.create(email: "santa@example.com", password: "12345678", id: 5)
Profile.create(name: "Santa Claus", level: 23, city: "Sydney", country: "AU", age: 16, bio: "This is my great bio", user_id: 5)
